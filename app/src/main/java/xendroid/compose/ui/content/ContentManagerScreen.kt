...
fun ContentManagerScreen(
    ...
    Scaffold(
        topBar = {
            XdTopBar(
                title = if (gameName.isNotBlank()) "Content · $gameName" else "Content",
                        ...
                        if (items.isEmpty()) {
                            if (selectedTab == 0) {
                                EmptyState(
                                    ...
                                    title = "No DLC installed",
                                    message = "Tap the + button to install downloadable content for this game.",
                                )
                            } else {
                                EmptyState(
                                    icon = Icons.Outlined.CloudDownload,
                                    title = "No title updates installed",
                                    message = "Tap the + button to install a title update for this game.",
                                )
                            }
                        } else {
