...
/**
 * Standard bottom-navigation transition: keep the three top-level destinations
 * (Library / Settings / About) as saved tabs so switching tabs restores state,
 * while detail screens still push on top.
 */
